...
public class UpdateService extends Service {
    ...
    private void buildNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (mChannel == null) {
                ...
                mChannel = new NotificationChannel("Update", "版本升级", importance);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                final File file = new File(AppInfoUtil.getDownloadDir(updateServiceWeakReference.get()),
                        AppInfoUtil.getFileName(httpConnection));
    ...
    private void success(String path) {
        Intent i = InstallApkUtil.installIntent(this, path);
        if (builder != null && !isForceUpdate) {
